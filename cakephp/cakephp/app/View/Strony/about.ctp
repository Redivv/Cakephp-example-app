...
<section class="about">
  ...
  <div class="photo-box">
    <!-- photo row -->
    <div class="photo">
      <img class="photo_img anim" src="<?php if(isset($element['Photo'][1][1][1])){echo $element['Photo'][1][1][1];} ?>" alt="">
    </div>
    <div class="photo">
      <img class="photo_img anim" src="<?php if(isset($element['Photo'][1][2][1])){echo $element['Photo'][1][2][1];} ?>" alt="">
    </div>
    <div class="clearfix"></div>
    <!-- Photo row -->
    <!-- photo row -->
    <div class="photo">
      <img class="photo_img anim" src="<?php if(isset($element['Photo'][1][3][1])){echo $element['Photo'][1][3][1];} ?>" alt="">
    </div>
    <div class="photo">
      <img class="photo_img anim" src="<?php if(isset($element['Photo'][1][4][1])){echo $element['Photo'][1][4][1];} ?>" alt="">
    </div>
    <div class="clearfix"></div>
    <!-- Photo row -->
  </div>
