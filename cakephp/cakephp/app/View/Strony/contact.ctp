  ...
  <div class="container">
    <div class="form col-md-8" style="padding:0;">
      <div class="kontakt_box_all1">
        <div class="contact_form_name col-md-6" style="padding:0;">
  				<input class="" style="width:100%;" id="c_name" placeholder="imię">
  				<div class="error err_c_name"></div>
        </div>
        <div class="contact_form_mail col-md-6" style="padding:0;">
  				<input style="width:100%;" class="" id="c_email" placeholder="email">
